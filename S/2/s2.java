...
public class s2 {
    ...
    public static String compressString(String userString) {
        ...
        for (int i = 0; i < userString.length()-1; i++) {
           ...
           if (i == userString.length()-2 && userString.charAt(userString.length()-2)!=userString.charAt(userString.length()-1))
           {
            result.append(userString.charAt(i));
           }

           else if (i == userString.length()-2 && userString.charAt(userString.length()-2)==userString.charAt(userString.length()-1))
           {
            count++;
            result.append(userString.charAt(i));
            result.append(count);
